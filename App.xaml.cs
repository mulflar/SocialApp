...
namespace Partyme
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            if (device_id == null)
            {
                device_id = Windows.Phone.System.Analytics.HostInformation.PublisherHostId;
            }
        ...
        private void ApplicationBarIconButton_Click12(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click13(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click14(object sender, EventArgs e)
        {

        }
        
        //metodos de la appbar de planes
        private void ApplicationBarIconButton_Click21(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click22(object sender, EventArgs e)
        {

        }
        
        //metodos de la appbar de amigos
        private void ApplicationBarIconButton_Click31(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click32(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click33(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click34(object sender, EventArgs e)
        {

        }

        //metodos de la appbar de servicios
        private void ApplicationBarIconButton_Click41(object sender, EventArgs e)
        {

        }
        private void ApplicationBarIconButton_Click42(object sender, EventArgs e)
        {

        }

        //metodos de la appbar de perfil
        private void ApplicationBarIconButton_Click51(object sender, EventArgs e)
        {
            ((MainPage)App.Current.RootVisual).cambioperfil();
        }

        private void ApplicationBarIconButton_Click52(object sender, EventArgs e)
        {

        }

        private void ApplicationBarIconButton_Click53(object sender, EventArgs e)
        {
